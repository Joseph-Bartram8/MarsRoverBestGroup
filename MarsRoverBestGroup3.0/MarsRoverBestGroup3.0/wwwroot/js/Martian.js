...
PlayState.prototype.draw = function (game, dt, ctx) {
    ...
    ship_image.src = "../Images/space_degu_pix.png";
    ctx.drawImage(ship_image, this.ship.x - (this.ship.width / 2), this.ship.y - (this.ship.height / 2));
    ctx.fillRect(this.ship.x - (this.ship.width / 2), this.ship.y - (this.ship.height / 2), this.ship.width, this.ship.height);

    //  Draw invaders.
    invader_image = new Image();
    invader_image.src = "../Images/martian_pix.png";
    for (var i = 0; i < this.invaders.length; i++) {
        var invader = this.invaders[i];
        ctx.drawImage(invader_image, invader.x - invader.width / 2, invader.y - invader.height / 2);
    ...
    rocket_image.src = "../Images/carrocket_pix.png";
    for (var i = 0; i < this.rockets.length; i++) {
        var rocket = this.rockets[i];
        ctx.drawImage(rocket_image, rocket.x - 10, rocket.y - 20);
        //ctx.fillRect(rocket.x, rocket.y - 2, 1, 4);
    }

    //  Draw bombs.
    bomb_image = new Image();
    bomb_image.src = "../Images/bomb_pix.png";
    for (var i = 0; i < this.bombs.length; i++) {
        var bomb = this.bombs[i];
        ctx.drawImage(bomb_image, bomb.x - 10, bomb.y);
    }
